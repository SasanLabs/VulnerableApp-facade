...
describe("CommandInjection content", () => {
  describe("CommandInjection LEVEL_1 content", () => {
    ...
    it("renders vulnerability description section", async () => {
      ...
      await waitFor(() => {
        ...
        expect(link2).toHaveAttribute("href", "https://owasp.org/www-community/attacks/Command_Injection");
      });
    });

    it("renders practice vulnerability description section", () => {});

    it("renders hints section", () => {});
  });

  describe("CommandInjection LEVEL_2 content", () => {});

  describe("CommandInjection LEVEL_3 content", () => {});

  describe("CommandInjection LEVEL_4 content", () => {});

  describe("CommandInjection LEVEL_5 content", () => {});

  describe("CommandInjection LEVEL_6 content", () => {});
});
